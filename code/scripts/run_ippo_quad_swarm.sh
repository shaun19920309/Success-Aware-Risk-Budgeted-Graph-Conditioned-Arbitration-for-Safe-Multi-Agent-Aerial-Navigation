...
export TRAIN_DIR="${TRAIN_DIR:-$BASE/results/ippo_quad_swarm/${QUADS_MODE}_${NUM_AGENTS}agents_${TRAIN_STEPS}steps}"
export TRAIN_STEPS NUM_AGENTS QUADS_MODE USE_OBSTACLES USE_CUDA
