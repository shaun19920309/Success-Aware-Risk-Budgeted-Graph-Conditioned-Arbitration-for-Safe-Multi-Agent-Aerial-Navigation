#!/usr/bin/env python
"""Train QuadSwarm with a slot-native position reward target."""
...
def find_project_base() -> Path:
    ...
    for candidate in path.parents:
        if (candidate / "scripts/quad_swarm_slot_reward_adapter.py").is_file():
            return candidate
...
from quad_swarm_slot_reward_adapter import QuadSwarmSlotRewardOnPolicyEnv


if __name__ == "__main__":
    train_quad_swarm.QuadSwarmEnv = QuadSwarmSlotRewardOnPolicyEnv
